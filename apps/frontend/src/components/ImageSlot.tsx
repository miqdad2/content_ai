...
export function ImageSlot({ file, label, onPick, onClear, aspectClass = "aspect-[3/4]" }: Props) {
  ...
  return (
    <div className={cn("relative overflow-hidden rounded-xl border border-glass-border bg-white/[0.02]", aspectClass)}>
      {url ? (
        <>
          ...
          <button
            ...
            className="absolute right-0.5 top-0.5 flex h-11 w-11 items-center justify-center rounded-full bg-black/70 text-white"
          >
