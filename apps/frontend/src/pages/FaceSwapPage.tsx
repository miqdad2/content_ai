  ...
  return (
    <div className="mx-auto max-w-6xl space-y-8 px-4 py-8 sm:py-10">
      ...
      <Tabs
        ...
        className="glass-medium rounded-3xl p-4 shadow-xl shadow-black/20 sm:p-6"
      >
        <TabsList className="glass-light grid h-auto w-full grid-cols-2 rounded-xl p-1 sm:w-auto">
