  ...
  return (
    <LegalPage title="Terms of Service" updated="June 30, 2026">
      <p className="text-sm leading-7 text-muted-foreground">
        These Terms of Service (&ldquo;Terms&rdquo;) govern your access to and use of Video Arena.
        By creating an account or using the service, you agree to these Terms.
      </p>

      <LegalSection heading="Eligibility & accounts">
        <p>
          You must be at least 18 years old to use Video Arena. You are responsible for keeping your
      ...
      <LegalSection heading="Disclaimer & liability">
        <p>
          ...
          extent permitted by law, Video Arena is not liable for any indirect or consequential
